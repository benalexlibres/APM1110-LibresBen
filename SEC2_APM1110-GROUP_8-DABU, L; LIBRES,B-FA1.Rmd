...
subtitle: "Github: https://github.com/dabulira20/Prob-ProbDi-FAs/tree/main/FA1"
output: pdf_document
date: "`r Sys.Date()`"
---
...
### Problem 1
```
Write the skewness program, and use it to calculate the skewness coefficient of the four 
examination subjects in results.txt (results.csv). What can you say about these data? 
Is Pearson’s approximation reasonable?
```
...
(a)  form the stem-and-leaf display for each gender, and discuss the advantages 
of this representation compared to the traditional histogram; 
...
**Github Link:** <https://github.com/dabulira20/Prob-ProbDi-FAs/tree/main/FA1>